...
const resources = {
  ...
  ru: {
    translation: {
      ...
      "Select group to attend": "Выберите группу из списка выше для посещения",
      "Delay time": "Время опоздания",
      "Enter the tardy time for the following student":
        "Введите время опоздания для следующего студента:",
      "How many minutes was the student late?":
        "На сколько минут студент опоздал?",
      "Enter the tardy time for the following student:":
        "Введите время опоздания для следующего студента:",
      Student: "Студент",
      Minute: "Минуты",
      ...
      "Do you have an account?": "У вас уже есть аккаунт?",
